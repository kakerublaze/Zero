class Endpoints {
  ...
  static const String trendingAnime = 'meta/anilist/trending';
  // --> Airing Schedule API's
  static const String airingScheduleAnime = 'meta/anilist/airing-schedule';
  // --> Popular Anime API's
  static const String popularAnime = 'meta/anilist/popular';
  // --> Recent Anime Episode API's
  static const String recentAnimeEpisodes = 'meta/anilist/recent-episodes';
  // --> Suggested Anime For You API's
  static const String suggestedAnimeForYou = 'meta/anilist/random-anime';
  // --> Manga List API's
  static const String mangaList = 'api/mangaList';
